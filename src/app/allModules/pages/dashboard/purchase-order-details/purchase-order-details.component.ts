...
import {
    ...
    PO_Item,
    PO_ScheduleDetails,
    PO_AdvanceShipmentNotification,
    PO_GRN,
...
export class PurchaseOrderDetailsComponent implements OnInit {
    ...
    AdvanceShipmentDisplayedColumns: string[] = ['ShipId', 'Item', 'Material', 'Description', 'UOM', 'ShipmentQuantity', 'ASNStatus', 'CargoType'];
    ...
    constructor(
        ...
        this.route.queryParams.subscribe(params => {
            this.POId = params['id'];
            this.dashboardService.GetPOPurchaseOrderDetails(this.POId).subscribe(
                data => {
                    if (data) {
    ...
    Checked(data) {
        ...
        this.dashboardService.GetPOOrderLookUpDetails(this.selectedPORow.PO_Item_PO, this.selectedPORow.Item).subscribe(
            data1 => {
                if (data1) {
